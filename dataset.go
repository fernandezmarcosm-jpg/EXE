...
func canonicalDateRaw(raw string) string {raw=strings.TrimSpace(raw);if raw==""{return ""};if n,err:=strconv.ParseFloat(strings.ReplaceAll(raw,",","."),64);err==nil&&n>=1&&n<100000{return excelSerialDate(n,false).Format("2006-01-02")};for _,layout:=range []string{"2006-01-02 15:04:05","2006-01-02T15:04:05","2006-01-02","02/01/2006","2/1/2006","2006/01/02","02-01-2006","2-1-2006","02/01/2006 15:04:05"}{if t,err:=time.Parse(layout,raw);err==nil{if strings.Contains(layout,"15:04:05")||strings.Contains(raw,"T"){return t.Format("2006-01-02 15:04:05")};return t.Format("2006-01-02")}};return raw}
...
func lookupDateOnly(t time.Time) time.Time{return time.Date(t.Year(),t.Month(),t.Day(),0,0,0,0,time.UTC)}
